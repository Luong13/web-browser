...
class JSContext:
    def __init__(self, tab):
        ...
        self.interp.export_function("document_setCookie", self.document_setCookie)
        self.interp.export_function("document_getCookie", self.document_getCookie)
    ...
    def document_setCookie(self, cookie):
        global COOKIE_JAR
...
class Tab:
    ...
    def load(self, url, body=None):
        headers, body = request(url, self.url, body, self.refer_policy)
        self.scroll = 0
        self.url = url
        ...
        for script in scripts:
            ...
            if not self.allowed_request(script_url):
                ...
                continue
            header, body = request(script_url, url, refer_policy=self.refer_policy)
            #try:
        ...
        for link in links:
            ...
            if not self.allowed_request(style_url):
                ...
                continue
            try:
                header, body = request(style_url, url, refer_policy=self.refer_policy)
            except:
                continue
